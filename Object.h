 ...
 *
 * An Object is a geometric entity that can be seen in a camera, such as a Sphere. 
 * The term 'Object' is commonly used, but creates a bit of tension 
 * with the 'object' in 'object-oriented programming'. For this documentation a 'big-O' 
 * Object is a thing that can be seen by a camera, and a 'little-o' object is a data 
 * structure with members and methods etc. Hopefully this will be clear from context 
 * anyway.
 *
 ...
 *
 * As an abstract base class, you cannot create an Object directly.
