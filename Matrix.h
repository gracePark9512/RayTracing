 ...
 *
 * The class is designed to be simple and easy to understand rather than optimal or hyper-efficient.
 * For production code a more professional library (such as <a href="http://http://eigen.tuxfamily.org">Eigen</a>) is recommended.
 */
class Matrix {
...
public:
	...
	* It could also be defined in terms of a \c *= operator, but it is not clear whether
	* A *= B; means A = A*B or A = B*A. So this is omitted to avoid confusion.
	*
